...
from tracker.views import (PleasantHabitViewSet, UsefulHabitCreateView, UsefulHabitDetailView, UsefulHabitDeleteView, UsefulHabitListView, UsefulHabitUpdateView)
